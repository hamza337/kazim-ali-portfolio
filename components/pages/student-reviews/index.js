...
import { DeleteReview, GetAllReviews } from "../../../redux/action";
...
const StudentReviews = () => {
    ...
    useEffect(() => {
        dispatch(GetAllReviews(onError))
    }, [])
    ...
    const deleteReview = (item) => {
        dispatch(DeleteReview(item.id,onError))
    }
    return (
                                        ...
                                        <tbody className="table-border-bottom-0">
                                            {
                                                review.allReviews.map((item, index) => {
                                                    ...
                                                    return (
                                                        <tr key={index}
                                                            onClick={() => { router.push(`/student-reviews/details/${item.id}`) }}>
                                                            <td>
                                                                <span>
                                                                    {item.title}
                                                                </span>
...
export default withAuth(StudentReviews);
